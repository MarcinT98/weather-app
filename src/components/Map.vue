    ...
    <div class="mapContainer">
      ...
      >
        ...
        <path
          ...
          name="małopolskie"
        ></path>
        <svg class="circles" v-for="city in cities" :key="city.name">
          <circle
            :name="city.name"
            :cx="calculateX(city)"
            :cy="calculateY(city)"
...
export default {
  ...
  methods: {
    calculateX: function (city) {
      let mapEZero = 14.07;
      let mapEFull = 24.27;
      let degE = 1000 / Math.abs(mapEZero - mapEFull);
      return Math.round(Math.abs(city.E - mapEZero) * degE * 100) / 100;
    },
    calculateY: function (city) {
      let mapNZero = 54.9;
      let mapNFull = 49.0;
